...
def generate_launch_description():
    ...
    vision_weapon_state_topic = LaunchConfiguration('vision_weapon_state_topic')
    vision_pole_state_topic = LaunchConfiguration('vision_pole_state_topic')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('vision_weapon_state_topic', default_value='/vision/weapon_cmd_state_2'),
        DeclareLaunchArgument('vision_pole_state_topic', default_value='/vision/pole_cmd_state_2'),
        Node(
            package='r2_serial',
            ...
            parameters=[{
                ...
                'topics.vision_weapon_state': vision_weapon_state_topic,
                'topics.vision_pole_state': vision_pole_state_topic,
            }],
        ),
    ])
